# NOTE: Originally from langchain-core
	...
	def __init__(
		...
		if send_to_llm and (observation is None or llm_output is None):
			msg = (
				...
				" are required if 'send to llm' is True"
			)
...
def create_message(*, message: str, error_code: ErrorCode) -> str:
	return (
		f"{message}\n"
		"For troubleshooting, visiti: https://python.langchain.com/docs/"
		f"troubleshooting/errors/{error_code.value} may help."
		"Consider that we just borrowed langchain implementation"
		"For initial PoC."
	)